...
export default function SelectTaxCategory({ defaultValues, id, name, label, setFieldValue, error, disabled }){
  ...
  const loadTaxCategorys = () => {
    taxCategoryService.getTaxCategoryList().then((result) => {
